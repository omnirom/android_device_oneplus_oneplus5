...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private void vibe(boolean isFpgesture){
        ...
        if (doVibrate && isFpgesture && mPolicy != null) {
            mPolicy.performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, doVibrate);
        } else if (doVibrate && !isFpgesture && mPolicy != null) {
