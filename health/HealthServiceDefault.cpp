...
const char kUFSHealthFile[] = "/sys/kernel/debug/1d84000.ufshc/dump_health_desc";
const char kUFSHealthVersionFile[] = "/sys/kernel/debug/1d84000.ufshc/show_hba";
const char kDiskStatsFile[] = "/sys/block/sda/stat";
const char kUFSName[] = "UFSHC";
